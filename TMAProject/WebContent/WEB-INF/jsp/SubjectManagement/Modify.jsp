...
<body>
	...
	<div class="wrapper p7">
		<div style="padding-left: 150px; padding-top: 0px; margin-top: 0px;">
			<h1 style="color: red;">
				<fmt:message key="Subject.Modify" />
			</h1>
			<div class="clear"></div>
			<p />
			<form:form commandName="subjectModifyForm">
				<form:errors path="*" cssClass="errorblock" element="div" />
				<div style="float: right; margin-right: 50px;">
					<input class="button1" type="submit" name="Modify" value="Modify" />
					<a href="../SubjectManagement/Home.html" class="button1">Back</a>
				</div>
				<c:out value="${subjectBean.subjectId}"/>
				...
				<table id="tableupdate">
					...
					<form:hidden path="oldSubjectName"/>
				</table>
				<br />
			</form:form>
		</div>
