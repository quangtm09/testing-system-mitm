...
<body>
	<div class="wrapper p7">
		<div style="padding-left: 150px; padding-top: 0px; margin-top: 0px;">
			<h1 style="color: red">
				<fmt:message key="Upload.Error" />
			</h1>
			<br>
			<br>
			<br>
			<div class="errorblock"> ${errorMessage}
				Please try again! You may encounter one of these errors below:<br>

				<fmt:message key="required.fileUpload" />
				<br>


				<fmt:message key="error.FileAlreadyExists" />
				<br>


				<fmt:message key="error.NoSubject" />
				<br>

			</div>
			<a href="../SubjectManagement/Home.html" class="button1">Back </a> <a
				href="../SubjectManagement/Upload.html" class="button1">Upload
				Again</a>
		</div>
	</div>
