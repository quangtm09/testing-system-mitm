...
public class PermissionConstant {
	...
	public static final int EDIT_TEST = 2;
	public static final String str_EDIT_TEST = "Edit Test";
	
	// Do Test Permission
	public static final int DO_TEST = 3;
	public static final String str_DO_TEST = "Taking Test";
	
	// VIew Test Permission
	public static final int VIEW_TEST = 4;
	public static final String str_VIEW_TEST = "View Test";
