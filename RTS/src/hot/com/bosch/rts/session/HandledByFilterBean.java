/**
 * /rts/src/hot/com/bosch/rts/session/HandledByFilterBean.java
 */
...
/**
 * Filter utilities for handled by form fields.
 *
 * @author KHB1HC
 */
@Name(value = "handledByFilter")
public class HandledByFilterBean {
	...
	/**
	 * Instantiates a new handled by filter bean.
	 */
	public HandledByFilterBean(){
